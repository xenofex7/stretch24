...
const POSES = {
  neckSide: FIG(`
    <circle cx="60" cy="26" r="11" fill="currentColor" stroke="none" transform="rotate(20 60 40)"/>
    <path d="M60 38 V70 M60 44 L38 60 M60 44 L82 60 M60 70 L48 105 M60 70 L72 105"/>
    <path d="M78 26 q10 -6 14 4" class="accent-stroke"/>
  `),
  neckFront: FIG(`
    <circle cx="60" cy="30" r="11" fill="currentColor" stroke="none" transform="translate(4 6) rotate(25 60 30)"/>
    <path d="M60 42 V72 M60 48 L40 64 M60 48 L80 64 M60 72 L48 106 M60 72 L72 106"/>
  `),
  shoulderRoll: FIG(`
    <circle cx="60" cy="24" r="11" fill="currentColor" stroke="none"/>
  ...
  `),
  triceps: FIG(`
    <circle cx="58" cy="30" r="11" fill="currentColor" stroke="none"/>
  ...
  `),
  fig4: FIG(`
    <circle cx="20" cy="58" r="10" fill="currentColor" stroke="none"/>
    <path d="M30 62 L62 66 M62 66 Q80 56 92 62 M62 66 L78 84 M78 84 L64 92 M40 64 L52 80"/>
  `),
  kneeHug: FIG(`
    <circle cx="22" cy="66" r="10" fill="currentColor" stroke="none"/>
    <path d="M32 70 L66 72 M66 72 Q76 58 66 50 M66 72 L96 80 M40 70 Q56 52 68 56"/>
  `),
  wrist: FIG(`
    <circle cx="42" cy="26" r="11" fill="currentColor" stroke="none"/>
    <path d="M44 38 V72 M44 46 L86 46 M86 46 L92 34 M44 46 L28 60 M28 60 L86 46 M44 72 L34 106 M44 72 L54 106"/>
  `),
  supineTwist: FIG(`
    <circle cx="18" cy="60" r="10" fill="currentColor" stroke="none"/>
    <path d="M28 64 L64 66 M40 64 L44 44 M64 66 Q76 78 70 92 M70 92 L88 88 M64 66 L96 62"/>
  `),
  fullStretch: FIG(`
    <circle cx="38" cy="70" r="10" fill="currentColor" stroke="none"/>
    <path d="M46 72 L84 72 M48 70 Q30 58 18 60 M50 74 Q34 66 20 68 M84 72 L104 66 M84 74 L104 78"/>
  `),
  hipFlex: FIG(`
    <circle cx="52" cy="24" r="11" fill="currentColor" stroke="none"/>
...
const EXERCISES = [
  ...
  { id: 'shoulder-roll',   name: 'Schulterkreisen',             cat: 'Nacken & Schultern', pose: 'shoulderRoll', sides: false,
    desc: 'Schultern groß und langsam nach hinten kreisen: hochziehen, nach hinten, fallen lassen. Löst Verspannungen vom Sitzen.' },
  ...
  { id: 'cat-cow',         name: 'Katze-Kuh',                   cat: 'Rücken & Rumpf',     pose: 'catCow',      sides: false,
    desc: 'Im Vierfüßlerstand mit der Einatmung ins Hohlkreuz (Blick nach vorn), mit der Ausatmung den Rücken rund machen. Fließend im Atemrhythmus bewegen.' },
  ...
  { id: 'lunge',           name: 'Tiefer Ausfallschritt',       cat: 'Hüfte & Beine',      pose: 'lunge',       sides: true,
    desc: 'Großer Schritt nach vorn, vorderes Knie über dem Sprunggelenk. Hüfte tief sinken lassen, Hände auf dem Oberschenkel oder am Boden.' },
  ...
  { id: 'butterfly',       name: 'Schmetterling',               cat: 'Hüfte & Beine',      pose: 'butterfly',   sides: false,
    desc: 'Im Sitzen die Fußsohlen aneinanderlegen, Fersen Richtung Körper. Knie sanft Richtung Boden sinken lassen, Rücken lang.' },
  { id: 'fig4',            name: 'Figur 4 im Liegen',           cat: 'Hüfte & Beine',      pose: 'fig4',        sides: true,
    desc: 'In Rückenlage einen Knöchel aufs andere Knie legen und das untere Bein zur Brust ziehen. Dehnt Gesäß und Außenseite der Hüfte.' },
  ...
  { id: 'quad',            name: 'Oberschenkel-Vorderseite',    cat: 'Hüfte & Beine',      pose: 'quad',        sides: true,
    desc: 'Im Stand eine Ferse zum Gesäß ziehen, Knie zeigen zueinander. Becken leicht aufrichten. Bei Bedarf an einer Wand festhalten.' },
